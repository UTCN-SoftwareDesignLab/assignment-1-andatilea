...
public abstract class BaseControllerTest {
    ...
    protected ResultActions performPatchWithRequestBodyAndVariable(String path, Object body, Object pathVariable) throws Exception {
    ...
    protected ResultActions performDeleteWithPathVariable(String path, Object pathVariable) throws Exception {
        return mockMvc.perform(delete(path, pathVariable)
                .content(asJsonString(pathVariable))
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON));
    }
