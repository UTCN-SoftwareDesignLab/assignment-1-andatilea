...
public class UserServiceMySQL implements UserService {
    ...
    @Override
    public Notification<User> findByUsernameAndPassword(String username, String password) { return userRepository.findByUsernameAndPassword(username, password); }
    ...
    @Override
    public Notification<Boolean> update(User user) { return userRepository.update(user); }
