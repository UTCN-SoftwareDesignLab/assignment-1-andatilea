...
public class ComponentFactory {
    ...
    private ComponentFactory(Boolean componentsForTests) {
        ...
        this.loginController = new LoginController(loginView, authenticationService, userRepository, administratorView, employeeView);
        this.adminController = new AdministratorController(administratorView, authenticationService, connection, rightsRolesRepository);
        this.employeeController = new EmployeeController(employeeView, connection, clientService, accountService);
