...
public class Account {
    ...
    public int getAmount_of_money() { return amount_of_money; }
    ...
    public String toString(){
        String accountString = "  ACCOUNT IDENTIFICATION NR: " + this.getIdentification_nb() + ",\nAMOUNT OF MONEY: " + this.getAmount_of_money() +
                ", TYPE: " + this.getType() + ", DATE: " + this.getDate_of_creation();
